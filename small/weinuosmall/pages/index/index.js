...
Page({
  ...
  materialcaiguo: function (e) {
    wx.navigateTo({
      url:"../material/materialcaigou/materialcaigou"
    })
  },
  materialchuku: function (e) {
    wx.navigateTo({
      url: "../material/materialchuku/materialchuku"
    })
  },
  ...
  selectshengchanhuanjie: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        wx.setStorageSync("huanjielength", res.data.data[0].list.length)
      }
    })
  },
