...
Page({
  ...
  onLoad: function(e) {
    this.setData({
      xinghao:wx.getStorageSync("xinghao"),
      materialname:wx.getStorageSync("materialname"),
      begintime: wx.getStorageSync("chukubegin")||"",
      endtime:wx.getStorageSync("chukuend")||""
  ...
  selectmaterialorder: function(page) {
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        wx.setStorageSync("xinghao",""),
        wx.setStorageSync("materialname",""),
        wx.setStorageSync("chukubegin",""),
        wx.setStorageSync("chukuend","")
      }
    })
  },
