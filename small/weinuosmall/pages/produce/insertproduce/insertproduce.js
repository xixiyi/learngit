    ...
    wx.request({
      ...
      success: function(res) {
        that.setData({
          ...
          mishu:res.data.data[0].mishu,
          yishangchuannum: res.data.data[0].yishangchuannum||""
        })
        if (count == 1) {
    ...
    wx.request({
      ...
      success: function(res) {
        if (res.data.data[0] == "添加成功") {
          ...
          var xingguangongxuarr = that.data.xingguangongxucontentarr
          for (var i = 0; i < xingguangongxuarr.length; i++) {
            var xingguangogxu = {}
            xingguangogxu.checked = false
            xingguangongxuarr[i] = xingguangogxu
          }
          ...
          that.setData({
            ...
            xingguangongxucontentarr:xingguangongxuarr
          })
        } else {
